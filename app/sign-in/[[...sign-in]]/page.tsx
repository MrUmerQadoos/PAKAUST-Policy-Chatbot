          ...
          <SignIn
            appearance={{
              elements: {
                ...
                formFieldInput:
                  "bg-white/[0.04] border border-white/[0.08] text-[#e5e7eb] rounded-xl focus:border-[#3b82f6]/30 focus:ring-2 focus:ring-[#3b82f6]/10 text-[13px] placeholder:text-[#4b5563]",
                formFieldInputShowPasswordButton:
                  "text-[#6b7280] hover:text-[#9ca3af]",
                formButtonPrimary:
                  "bg-gradient-to-r from-[#3b82f6] to-[#8b5cf6] hover:from-[#2563eb] hover:to-[#7c3aed] text-white font-semibold rounded-xl text-[13px] transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] shadow-[0_4px_16px_rgba(59,130,246,0.2)]",
                footerActionLink:
                  "text-[#3b82f6] font-semibold text-[12px] hover:text-[#60a5fa] transition-colors",
                footerActionText:
                ...
                identityPreviewEditButton:
                  "text-[#3b82f6] text-[12px] font-semibold",
                alertText: "text-[13px]",
                formResetPasswordCodeFields: "gap-2",
              },
              variables: {
                colorPrimary: "#3b82f6",
